...
basedir='/home/vm/catkin_mrinal/src/darknet_ros/darknet_ros/Dataset/2011_09_26/2011_09_26_drive_0009_sync/velodyne_points/data'

if __name__ == '__main__':

    '''Sample code to publish a pcl2 with python'''
    rospy.init_node('pc_publish')
    pc_pub = rospy.Publisher("/kitti_pointcloud", PointCloud2,queue_size=2)
    ...
    for f in sorted(listdir(basedir)) :
        ...
        pc2 = point_cloud2.create_cloud(header, fields, pc_velo)
